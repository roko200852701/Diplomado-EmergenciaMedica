...
/**
 * Created by ricardo rojo ortiz on 04/06/2015.
 */
public class DMedico extends DPersona {
    ...
    public DMedico obtener(String ciMedico) {
        ...
        Cursor cursor = Manager.getBaseDatos().query(Constantes.tablaPersona, new String[]{
                ...
                Constantes.cCi + Constantes.igual + Constantes.comilla + ciMedico + Constantes.comilla, null, null, null, null);
    ...
    public DMedico obtenerPorMatricula(String sMatricula) {
        Manager.abrirLectura();
        Cursor cursor = Manager.getBaseDatos().query(Constantes.tablaPersona, new String[]{
                        Constantes.id,
                        Constantes.cNombre,
